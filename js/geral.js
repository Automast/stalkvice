...
// ============================================
const SITE_CONFIG = {
    name: window.CONFIG.site.name,
    fullName: window.CONFIG.site.fullName,
    description: window.CONFIG.site.description,
    apiPort: window.CONFIG.network.apiPort,
    defaultPort: window.CONFIG.network.defaultPort
